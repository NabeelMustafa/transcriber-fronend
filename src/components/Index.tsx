...
const Index = () => {
  return (
    <main id="transcript">
      <h1>Welcome to NRK transcription beta!</h1>
      <p>
      ...
      <p>
      Finally, a few words about access and source protection. Using the tool requires logging in with your NRK account. It is not possible to share a transcript link with others, so if you want to send the text to someone, it must first be exported to Word.
      </p>
      <p>Good luck !</p>
